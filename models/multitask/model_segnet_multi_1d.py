...
class SegNet(nn.Module):
    def __init__(self, output_dim=[13,1,3], num_channels=[64,128,256,512,512]):
        ...
        self.decoder_conv51 = conv3x3(in_planes=num_channels[0], out_planes=64)
        ...
        for i in range(self.num_task):
            ...
            layers.append(conv3x3(in_planes=64, out_planes=64))
            layers.append(nn.BatchNorm2d(64))
            layers.append(nn.ReLU(inplace=True))
            layers.append(conv1x1(in_planes=64, out_planes=output_dim[i], stride=1))
