...
class ShareNet(nn.Module):
    def __init__(self, num_channels=[32,64,128,256]):
        ...
        self.upsample_conv21 = deconv1x1(in_planes=num_channels[1], out_planes=num_channels[0], stride=2)
        self.upsample_bn21 = nn.BatchNorm2d(num_channels[0])
    ...
    def forward(self, x, weights=None, bn_mean=None, bn_var=None):
        if weights is None:
            ...
            x = self.relu(self.decoder_stage2_bn2(self.decoder_stage2_conv2(x)) + identity)
            identity = self.relu(self.upsample_bn21(self.upsample_conv21(x)))
            x = self.relu(self.decoder_stage2_bn3(self.decoder_stage2_conv3(x)))
            x = self.relu(self.decoder_stage2_bn4(self.decoder_stage2_conv4(x)) + identity)

            # Decoder stage 1
            identity = x
            x = self.relu(self.decoder_stage1_bn1(self.decoder_stage1_conv1(x)))
            x = self.relu(self.decoder_stage1_bn2(self.decoder_stage1_conv2(x)) + identity)
            identity = x
            x = self.relu(self.decoder_stage1_bn3(self.decoder_stage1_conv3(x)))
            x = self.relu(self.decoder_stage1_bn4(self.decoder_stage1_conv4(x)) + identity)
            ...
            # decoder stage 3
            identity = x
            x = self.conv_layer_ff(x, weights, 'decoder_stage3_conv1.weight', 1, 1, bn_mean, bn_var, 'decoder_stage3_bn1.running_mean', 'decoder_stage3_bn1.running_var', 'decoder_stage3_bn1.weight', 'decoder_stage3_bn1.bias', None)
            x = self.conv_layer_ff(x, weights, 'decoder_stage3_conv2.weight', 1, 1, bn_mean, bn_var, 'decoder_stage3_bn2.running_mean', 'decoder_stage3_bn2.running_var', 'decoder_stage3_bn2.weight', 'decoder_stage3_bn2.bias', identity)
            identity = self.deconv_layer_ff(x, weights, 'upsample_conv32.weight', 2, 0, bn_mean, bn_var, 'upsample_bn32.running_mean', 'upsample_bn32.running_var', 'upsample_bn32.weight', 'upsample_bn32.bias', None)
            x = self.conv_layer_ff(x, weights, 'decoder_stage3_conv3.weight', 1, 1, bn_mean, bn_var, 'decoder_stage3_bn3.running_mean', 'decoder_stage3_bn3.running_var', 'decoder_stage3_bn3.weight', 'decoder_stage3_bn3.bias', None)
            x = self.deconv_layer_ff(x, weights, 'decoder_stage3_conv4.weight', 2, 1, bn_mean, bn_var, 'decoder_stage3_bn4.running_mean', 'decoder_stage3_bn4.running_var', 'decoder_stage3_bn4.weight', 'decoder_stage3_bn4.bias', identity)

            # decoder stage 2
            identity = x
            x = self.conv_layer_ff(x, weights, 'decoder_stage2_conv1.weight', 1, 1, bn_mean, bn_var, 'decoder_stage2_bn1.running_mean', 'decoder_stage2_bn1.running_var', 'decoder_stage2_bn1.weight', 'decoder_stage2_bn1.bias', None)
            x = self.conv_layer_ff(x, weights, 'decoder_stage2_conv2.weight', 1, 1, bn_mean, bn_var, 'decoder_stage2_bn2.running_mean', 'decoder_stage2_bn2.running_var', 'decoder_stage2_bn2.weight', 'decoder_stage2_bn2.bias', identity)
            identity = self.deconv_layer_ff(x, weights, 'upsample_conv21.weight', 2, 0, bn_mean, bn_var, 'upsample_bn21.running_mean', 'upsample_bn21.running_var', 'upsample_bn21.weight', 'upsample_bn21.bias', None)
            x = self.conv_layer_ff(x, weights, 'decoder_stage2_conv3.weight', 1, 1, bn_mean, bn_var, 'decoder_stage2_bn3.running_mean', 'decoder_stage2_bn3.running_var', 'decoder_stage2_bn3.weight', 'decoder_stage2_bn3.bias', None)
            x = self.deconv_layer_ff(x, weights, 'decoder_stage2_conv4.weight', 2, 1, bn_mean, bn_var, 'decoder_stage2_bn4.running_mean', 'decoder_stage2_bn4.running_var', 'decoder_stage2_bn4.weight', 'decoder_stage2_bn4.bias', identity)

            # decoder stage 1
            identity = x
            x = self.conv_layer_ff(x, weights, 'decoder_stage1_conv1.weight', 1, 1, bn_mean, bn_var, 'decoder_stage1_bn1.running_mean', 'decoder_stage1_bn1.running_var', 'decoder_stage1_bn1.weight', 'decoder_stage1_bn1.bias', None)
            x = self.conv_layer_ff(x, weights, 'decoder_stage1_conv2.weight', 1, 1, bn_mean, bn_var, 'decoder_stage1_bn2.running_mean', 'decoder_stage1_bn2.running_var', 'decoder_stage1_bn2.weight', 'decoder_stage1_bn2.bias', identity)
            identity = x
            x = self.conv_layer_ff(x, weights, 'decoder_stage1_conv3.weight', 1, 1, bn_mean, bn_var, 'decoder_stage1_bn3.running_mean', 'decoder_stage1_bn3.running_var', 'decoder_stage1_bn3.weight', 'decoder_stage1_bn3.bias', None)
            x = self.conv_layer_ff(x, weights, 'decoder_stage1_conv4.weight', 1, 1, bn_mean, bn_var, 'decoder_stage1_bn4.running_mean', 'decoder_stage1_bn4.running_var', 'decoder_stage1_bn4.weight', 'decoder_stage1_bn4.bias', identity)
