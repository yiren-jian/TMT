...
class BranchNet(nn.Module):
    def __init__(self, output_dim=13, num_channels=[32,64,128,256,256]):
        ...
        self.conv32 = conv3x3(in_planes=num_channels[2], out_planes=num_channels[2])
        self.bn32 = nn.BatchNorm2d(num_channels[2])
        self.conv33 = conv3x3(in_planes=num_channels[2], out_planes=num_channels[1])
        self.bn33 = nn.BatchNorm2d(num_channels[1])
